...
class String_Utils {
    ...
    */
    ...
    // this is function get the variable for get and post
    static function filter_input_request($var_name, $filter_name = null, $want_post = true){
        $returned_val = null;
        if($_GET[$var_name] && $want_post){
            $returned_val = filter_input(INPUT_GET, $var_name, $filter_name);

        }elseif($_POST[$var_name]){
