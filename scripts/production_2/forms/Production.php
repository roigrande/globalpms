...
class Production_Form_Production extends Zend_Form {
    ...
    public function init() {
        ...
        $own_company_id = new Zend_Form_Element_Select('own_company_id');
        $own_company_id->setLabel('Own Company')
                ->setRequired(true)
                ->addValidator('NotEmpty', true)
                ...
                ->setDecorators(array(array('ViewScript', array(
                            'viewScript' => 'forms/_element_select.phtml'))))
        ;
        $client_company_id = new Zend_Form_Element_Select('client_company_id');
        $client_company_id->setLabel('Client Company')
                ->setRequired(true)
                ->addValidator('NotEmpty', true)
     ...
     protected function _selectOptionsOwnCompanies() {
        $sql = "SELECT companies.id,companies.name
                  ...
                  WHERE companies.id=own_companies.company_id";
