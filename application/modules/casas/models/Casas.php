...
/**
 * This is the Data Mapper class for the Acl_casass table.
 */
class Casas_Model_Casass {
    ...
    public function getTable() {
        if (null === $this->_table) {
            $this->_table = new Casas_Model_DbTable_Casass();
        }
        return $this->_table;
    }
    ...
    public function fetchSql() {
        $sql = "SELECT acl_casass.id, acl_casass.name, date,
                    email,status, person_id,
                    validation_code,phone, acl_roles.name as role
          FROM acl_casass, acl_roles
          WHERE acl_casass.role_id = acl_roles.id              
     ...
     * @return array
     */
    public function fetchCasass($role_id) {
