...
class Controlmodule_Form_Controlmodulexml extends Zend_Form {
    public function init() {
        ...
        $codepool = new Zend_Form_Element_Text('codepool');
        $codepool->setLabel('Codepool')
                ->addFilter('StripTags')
                ->addFilter('StringTrim')
                ->addValidator('NotEmpty');
        ...
        $submit->setAttrib('name','version','description'.'copyright','developer','codepool', 'submitbutton');

        $this->addElements(array($name,$version,$copyright,$description,$developer,$codepool,$submit));
    }
