...
/**
* This is the Data Mapper class for the Acl_managementtypes table.
*/
class Managementtype_Model_Managementtype {
...
*/
    public function getTable() {
        if (null === $this->_table) {
            $this->_table = new Managementtype_Model_DbTable_Managementtype();
        }
        return $this->_table;
    }
...
*/
    public function fetchSql() {
        $sql = "SELECT managementtypes.id, managementtypes.name, date,
email,status, roles.name as role
FROM managementtypes, roles
WHERE managementtypes.role_id = roles.id
ORDER BY roles.id";

        $table = $this->getTable()->getAdapter()->fetchAll($sql);
        // Zend_Debug::dump($table,"Managementtype");
...
* @return array
*/
    public function fetchManagementtypes($type_id) {
